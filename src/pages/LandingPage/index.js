					...
					<div className="d-flex justify-content-end w-100">
						<div>
							<div className="my-form intro">
								<span>COMMERCIALE4.0.COM</span> is community of companies of the
								mechanical industry. We revolutionize the way companies connect
								with each other, building the networking of the future!
