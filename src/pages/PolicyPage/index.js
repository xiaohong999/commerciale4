    ...
    return (
      <div className="policy container">
        ...
        <p>
          ...
          tal fine Commerciale4.0 raccoglie e indicizza in modo automatico
          alcuni dati (numero di telefono; fotografie; città; codice Ateco;
          Indirizzi email; etc.) pubblicati sul web, consapevolmente e
          volontariamente, dalle Aziende e già indicizzati dai principali motori
          di ricerca (es. Google). Si tratta dunque di dati resi manifestamente
          pubblici dalle Aziende interessate e che, al momento della relativa
          raccolta e memorizzazione sul server Commerciale4.0, non riconducono a
          interessati identificati. Tuttavia, i dati di cui sopra, per loro
          stessa natura, possono, attraverso elaborazioni ed associazioni con
          dati detenuti da terzi, permettere di identificare la Azienda
          interessata.
        </p>
